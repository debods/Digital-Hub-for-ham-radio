...
Overview
--------
1 DigiHub is not an application or environment, it is a curated collection of ham radio utilities and applications geared toward Digital ham radio Operations.
...
1 DigiHub, builds on the concept of but unlike DigiPi is designed to be installed on an existing Debian system.
